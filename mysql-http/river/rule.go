...
// Rule is the rule for how to sync data from MySQL to entity.
// If you want to sync MySQL data into entity, you must set a rule to let use know how to do it.
// The mapping rule may thi: schema + table <-> index + document type.
// schema and table is for MySQL, index and document type is for entity.
type Rule struct {
	...
	// Default, a MySQL table field name is mapped to entity field name.
	// Sometimes, you want to use different name, e.g, the MySQL file name is title,
	// but in Eentity, you want to name it my_title.
